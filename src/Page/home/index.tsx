...
export function Home() {
  return (
    <Container aria-label="Página inicial">
      <WhatsAppButton
        href="https://api.whatsapp.com/send?phone=5516996027790&text=Ol%C3%A1%20Mania%20Play%20Brinquedos,%20vim%20atrav%C3%A9s%20do%20seu%20site,%20gostaria%20de%20obter%20mais%20informa%C3%A7%C3%B5es."
        target="_blank"
