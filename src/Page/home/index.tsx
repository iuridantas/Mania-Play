...
export function Home() {
  return (
    <Container
      ...
      title="Página inicial da Mania Play Brinquedos"
    >
      <WhatsAppButton
        ...
        aria-label="Botão do WhatsApp da Mania Play Brinquedos"
        title="Botão do WhatsApp da Mania Play Brinquedos"
      >
        <WhatsApp alt="Ícone representando o WhatsApp de Mania Play Brinquedos" />
      </WhatsAppButton>
      <SessionAboutUs />
      <SessionHowItWorks />
      <SessionModels />
